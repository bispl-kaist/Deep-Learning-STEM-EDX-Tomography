...
///////////////////////////////////////////////////////////////////////////
            ...
            void    RunDx(float *pdDst, float *pdSrc, int *pnSizeSrc);
__global__  void    Dx(float *pdDst, float *pdSrc, int nY, int nX, int nZ);
...
void RunDx(float *pdDst, float *pdSrc, int *pnSizeSrc)
{
    ...
    Dx<<<nGridNum, nBlockNum>>>(gpupdDst, gpupdSrc, nY, nX, nZ);
