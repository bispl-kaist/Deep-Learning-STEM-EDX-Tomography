...
///////////////////////////////////////////////////////////////////////////
            ...
            void    RunDxT(float *pdDst, float *pdSrc, int *pnSizeSrc);
__global__  void    DxT(float *pdDst, float *pdSrc, int nY, int nX, int nZ);
...
void RunDxT(float *pdDst, float *pdSrc, int *pnSizeSrc)
{
    ...
    DxT<<<nGridNum, nBlockNum>>>(gpupdDst, gpupdSrc, nY, nX, nZ);
...
__global__  void    DxT(float *pdDst, float *pdSrc, int nY, int nX, int nZ)
{
    ...
    int     nIdxXpost   = nIdxX + 1 < nX ? nIdxX + 1: 0;
    
    int     nIdx        = nY*nX*nIdxZ	+ nY*nIdxX      + nIdxY;
    int     nIdxpost	= nY*nX*nIdxZ	+ nY*nIdxXpost	+ nIdxY;
