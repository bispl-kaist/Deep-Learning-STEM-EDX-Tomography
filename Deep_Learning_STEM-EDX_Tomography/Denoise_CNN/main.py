...
parser.add_argument('--scope', default='denoising', help='add the scope at the checkpoint and log')
parser.add_argument('--input_dir', default='./data/denoising', help='directory where training datasets are located')
parser.add_argument('--output_dir', default='./result/denoising', help='directory where test results are saved')
