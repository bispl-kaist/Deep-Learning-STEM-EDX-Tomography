...
parser.add_argument('--scope', default='sr', help='add the scope at the checkpoint and log')
parser.add_argument('--input_dir', default='./data/sr', help='directory where training datasets are located')
parser.add_argument('--output_dir', default='./result/sr', help='directory where test results are saved')
...
parser.add_argument('--epoch_num', type=int, default=1000, help='the number of epoch')
...
parser.add_argument('--load_y_size', type=int, default=286, help='load size = the y-axis.')
parser.add_argument('--load_x_size', type=int, default=286, help='load size = the x-axis.')
