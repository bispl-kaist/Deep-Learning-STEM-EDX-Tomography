...
///////////////////////////////////////////////////////////////////////////
            ...
            void    RunDz(float *pdDst, float *pdSrc, int *pnSizeSrc);
__global__  void    Dz(float *pdDst, float *pdSrc, int nY, int nX, int nZ);
...
void RunDz(float *pdDst, float *pdSrc, int *pnSizeSrc)
{
    ...
    Dz<<<nGridNum, nBlockNum>>>(gpupdDst, gpupdSrc, nY, nX, nZ);
