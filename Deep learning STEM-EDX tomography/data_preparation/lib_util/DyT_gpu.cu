...
///////////////////////////////////////////////////////////////////////////
            ...
            void    RunDyT(float *pdDst, float *pdSrc, int *pnSizeSrc);
__global__  void    DyT(float *pdDst, float *pdSrc, int nY, int nX, int nZ);
...
void RunDyT(float *pdDst, float *pdSrc, int *pnSizeSrc)
{
    ...
    DyT<<<nGridNum, nBlockNum>>>(gpupdDst, gpupdSrc, nY, nX, nZ);
